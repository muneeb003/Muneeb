...
export const initFluid = (canvas) => {
  ...
  let config = {
    ...
    DENSITY_DISSIPATION: 0.6, // slow fade
    VELOCITY_DISSIPATION: 1.8, // higher = strokes lose speed faster (calmer look)

    PRESSURE: 0.25,
    PRESSURE_ITERATIONS: 25,

    CURL: 3.5, // reduce turbulence = calmer strokes

    SPLAT_RADIUS: 0.05, // visible stroke size
    SPLAT_FORCE: 4000, // softer stroke push (slower entry speed)

    SHADING: true,
    COLOR_UPDATE_SPEED: 4, // slower color cycling
